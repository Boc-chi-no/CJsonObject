...
namespace neb
{
    ...
    public:     // method of ordinary json object
        ...
        std::string operator()(const std::string& strKey,std::string precision,int divisor) const;
    ...
    public:     // method of json array
        ...
        std::string operator()(unsigned int uiWhich, std::string precision, int divisor) const;
